...
It follows that
\eQb
f_{rr} = \dfrac{1}{r}f_r + \dfrac{1}{r^2} f_{\theta theta} &=& \dfrac{-2}{r^2} + \dfrac{1}{r}
\dfrac{2}{r} + 0 = 0.
\eQe
...
&=& \dfrac{R^a}{a}(e^{ia\pi} - e^{-ia\pi}) \\
&=& i \dfrac{2R^a}{a}sin(a\pi ), 
\eQe
as desired. $\qed$
\end{solution}
...
\eQb
\left| \int_{C} (e^z - \bar{z}) dz \right| \leq 60,
\eQe
as desired. $\qed$
\end{solution}
